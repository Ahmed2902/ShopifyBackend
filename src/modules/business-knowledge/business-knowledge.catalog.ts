...
export const BUSINESS_KNOWLEDGE_CATALOG: readonly KnowledgeCapability[] = [
  ...
  {
    domain: 'PAID_MEDIA',
    description: 'Provider-reported campaigns, groups, ads, spend, delivery, conversions, value and efficiency.',
  ...
  },
  {
    ...
    entityTypes: ['STORE', 'CAMPAIGN', 'GROUP', 'AD', 'CREATIVE', 'PRODUCT', 'VARIANT', 'COLLECTION', 'LANDING_PAGE'],
...
export function knowledgeCatalog(): KnowledgeCapability[] {
