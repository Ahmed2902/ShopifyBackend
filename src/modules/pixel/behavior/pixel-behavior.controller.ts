...
import {
  pixelBehaviorReadService,
  type PixelBehaviorReadService,
} from './pixel-behavior.read.service.js';

export class PixelBehaviorController {
  constructor(private readonly service: PixelBehaviorReadService = pixelBehaviorReadService) {}
