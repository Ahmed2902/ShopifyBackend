...
process.env.REDIS_REST_TOKEN ??= 'test-redis-token';
...
process.env.GOOGLE_FRONTEND_REDIRECT_URI ??= 'http://localhost:3000/auth/callback';
process.env.RESEND_API_KEY ??= 're_test_key';
process.env.RESEND_FROM ??= 'Test App <onboarding@resend.dev>';
process.env.EMAIL_VERIFICATION_URL ??= 'http://localhost:3000/auth/verify-email';
process.env.PASSWORD_RESET_URL ??= 'http://localhost:3000/auth/reset-password';
...
process.env.META_SCOPES ??= 'ads_read,business_management,catalog_management';
