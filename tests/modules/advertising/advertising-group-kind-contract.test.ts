...
const writeRepository = readFileSync(
  'src/modules/advertising/advertising-write.repository.ts',
  'utf8',
);
...
describe('canonical advertising group-kind contract', () => {
  it('keeps AD_SET, AD_GROUP and ASSET_GROUP in the shared hierarchy and write boundary', () => {
    ...
    expect(writeRepository).toContain("kind: 'AD_SET' | 'AD_GROUP' | 'ASSET_GROUP'");
